...
import com.ko.statussaver.utils.AlertUtils;
import com.ko.statussaver.utils.Constants;
import com.ko.statussaver.utils.PermissionUtils;
...
//                    launchHomeScreen();
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                        boolean result = PermissionUtils.checkAndRequestPermissions(IntroActivity.this,IntroActivity.this);
                        if (!result) {
                            PermissionUtils.checkAndRequestPermissions(IntroActivity.this,IntroActivity.this);
                        } else {
